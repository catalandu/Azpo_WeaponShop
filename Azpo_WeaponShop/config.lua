...
ConfAmmu = {
    ...
    Type = {
		...
		Blanche = {
			{Label = 'Lampe Torche', Value = 'WEAPON_FLASHLIGHT', Price = 900},
			{Label = 'Poing américain', Value = 'WEAPON_KNUCKLE', Price = 1200},
			{Label = 'Couteau', Value = 'WEAPON_KNIFE', Price = 1500},
			{Label = 'Batte de baseball', Value = 'WEAPON_BAT', Price = 2000}
		},

		Armes = {
			{Label = 'Pétoire', Value = 'WEAPON_SNSPISTOL', Price = 150000},
			{Label = 'Tazer', Value = 'WEAPON_STUNGUN', Price = 5000}
		},

		Items = {
			{Label = 'Jumelle', Value = 'jumelles', Price = 3000},
			{Label = 'Kevlar', Value = 'kevlar', Price = 5000}
		}
	}
}